...
//>>>>>>> ab340170a8afd2309a1e223dc451da155ff59758
...
//attach interrupts to Buttons
    ...
    printf("Stop Button done\n");
    printf("Play button done\n");
        ...
        //Write the buffer out to SPI
            // for (int i = 0; i<2;i++){
              //   for (int x = 0; x<BUFFER_SIZE;x++){
                //     bufferPtr = buffer[i][x];
                     wiringPiSPIDataRW(SPI_CHAN, buffer[bufferReading][buffer_location],2);//SPI_CHAN, bufferPtr, 2);
                  //       }
                    // }
